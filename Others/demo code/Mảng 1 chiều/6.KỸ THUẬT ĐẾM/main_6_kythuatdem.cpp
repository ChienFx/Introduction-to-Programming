...
/*Bài 227, 228: Ko khó đâu*/ 
//Bài 229: Đếm giá trị phân biệt
int PhanBiet(int x, int a[], int n)
{
	int dem=0;
	for(int i = 0; i < n; i++)
		if( x == a[i]) {
...
//	return dem;
//}
//Bài 230: Liệt kê các phần tử phân biệt
//void LietKePhanBiet(int a[], int n)
//{
...
//			printf("%4d ",a[i]);
//}
/*Bài 231, 232, 233: Giống 230*/
//Bài 234: Cho 2 mảng thực a,b đếm số giá trị xuất hiện MỘT TRONG HAI MẢNG.==> Hay
void main(void)
{
	printf("6.Ky Thuat Dem");
	getch();
}